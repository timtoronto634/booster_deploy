...
/*!
 * @brief This class represents the structure CameraInfo defined by the user in
 * the IDL file.
 * @ingroup CameraInfo
 */
class CameraInfo : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   * @param x Reference to the object sensor_msgs::msg::CameraInfo that will be
   * copied.
   */
   ...
   */
  eProsima_user_DllExport void k(const sensor_msgs::msg::double__9& _k);

  /*!
   * @brief This function moves the value in member k
   * @param _k New value to be moved in member k
   */
  eProsima_user_DllExport void k(sensor_msgs::msg::double__9&& _k);
   ...
   */
  eProsima_user_DllExport void r(const sensor_msgs::msg::double__9& _r);

  /*!
   * @brief This function moves the value in member r
   * @param _r New value to be moved in member r
   */
  eProsima_user_DllExport void r(sensor_msgs::msg::double__9&& _r);
   ...
   */
  eProsima_user_DllExport void p(const sensor_msgs::msg::double__12& _p);

  /*!
   * @brief This function moves the value in member p
   * @param _p New value to be moved in member p
   */
  eProsima_user_DllExport void p(sensor_msgs::msg::double__12&& _p);
 ...
 public:
  ...
  eProsima_user_DllExport ~CameraInfo() override;
