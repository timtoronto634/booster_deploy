...
/*!
 * @brief This class represents the structure CompressedImage defined by the
...
class CompressedImage : public eprosima::fastdds::dds::TopicDataType {
 public:
   ...
   * @param x Reference to the object sensor_msgs::msg::CompressedImage that
   * will be copied.
   */
  eProsima_user_DllExport CompressedImage(const CompressedImage& x);
   ...
   * will be copied.
   */
  eProsima_user_DllExport CompressedImage(CompressedImage&& x) noexcept;
   ...
   * will be copied.
   */
  eProsima_user_DllExport CompressedImage& operator=(const CompressedImage& x);
   ...
   */
  eProsima_user_DllExport bool operator==(const CompressedImage& x) const;
   ...
   */
  eProsima_user_DllExport void format(const std::string& _format);

  /*!
   * @brief This function moves the value in member format
   * @param _format New value to be moved in member format
   */
  eProsima_user_DllExport void format(std::string&& _format);
 ...
 public:
  ...
  eProsima_user_DllExport ~CompressedImage() override;
